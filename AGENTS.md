...
本文件是 `bookstore` 仓库的 Codex 会话级协作约束。每次在本仓库开启会话或切换到本仓库工作时，先按本文件建立上下文，再开始分析、设计或修改。
...
- 对采用 DDD 或六边形架构的模块，新增和修改代码必须遵循该模块 `README.md` 中定义的层次、包结构和依赖方向。
...
- 这是实验性质的 Demo 项目，可以主动指出不推荐的代码风格、设计漏洞和可维护性风险。
